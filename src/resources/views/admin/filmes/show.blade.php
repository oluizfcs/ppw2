                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm">
                        <a href="/pessoas/{{ $diretor->pessoa->id }}" class="text-decoration-none text-light">
                            @if ($diretor->pessoa->imagens->isNotEmpty())
                                <img src="{{ asset('storage/' . $diretor->pessoa->imagens->first()->caminho) }}" alt="Foto de {{ $diretor->pessoa->nome }}"
                            ...
                            @else
                                <div class="d-flex align-items-center justify-content-center bg-secondary" style="height: 200px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-person-fill text-dark" viewBox="0 0 16 16">
                        ...
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title font-weight-bold m-0 small text-truncate" title="{{ $diretor->pessoa->nome }}">{{ $diretor->pessoa->nome }}</h6>
                        </div>
                    </div>
                </div>
            @empty
                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm">
                        <a href="/pessoas/{{ $produtor->pessoa->id }}" class="text-decoration-none text-light">
                            @if ($produtor->pessoa->imagens->isNotEmpty())
                                <img src="{{ asset('storage/' . $produtor->pessoa->imagens->first()->caminho) }}" alt="Foto de {{ $produtor->pessoa->nome }}"
                                    class="card-img-top img-fluid" style="height: 200px; object-fit: cover;">
                            @else
                                <div class="d-flex align-items-center justify-content-center bg-secondary" style="height: 200px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-person-fill text-dark" viewBox="0 0 16 16">
                        ...
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title font-weight-bold m-0 small text-truncate" title="{{ $produtor->pessoa->nome }}">{{ $produtor->pessoa->nome }}</h6>
                        </div>
                    </div>
                </div>
            @empty
                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm">
                        <a href="/pessoas/{{ $escritor->pessoa->id }}" class="text-decoration-none text-light">
                            @if ($escritor->pessoa->imagens->isNotEmpty())
                                <img src="{{ asset('storage/' . $escritor->pessoa->imagens->first()->caminho) }}" alt="Foto de {{ $escritor->pessoa->nome }}"
                                    class="card-img-top img-fluid" style="height: 200px; object-fit: cover;">
                            @else
                                <div class="d-flex align-items-center justify-content-center bg-secondary" style="height: 200px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-person-fill text-dark" viewBox="0 0 16 16">
                        ...
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title font-weight-bold m-0 small text-truncate" title="{{ $escritor->pessoa->nome }}">{{ $escritor->pessoa->nome }}</h6>
                        </div>
                    </div>
                </div>
            @empty
                    ...
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm">
                        <a href="/pessoas/{{ $ator->pessoa->id }}" class="text-decoration-none text-light">
                            @if ($ator->pessoa->imagens->isNotEmpty())
                                <img src="{{ asset('storage/' . $ator->pessoa->imagens->first()->caminho) }}" alt="Foto de {{ $ator->pessoa->nome }}"
                                    class="card-img-top img-fluid" style="height: 200px; object-fit: cover;">
                            @else
                                <div class="d-flex align-items-center justify-content-center bg-secondary" style="height: 200px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-person-fill text-dark" viewBox="0 0 16 16">
                        ...
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title font-weight-bold mb-1 small text-truncate" title="{{ $ator->pessoa->nome }}">{{ $ator->pessoa->nome }}</h6>
                            <div class="text-muted small text-truncate" style="font-size: 0.8rem;" title="{{ $ator->pivot->papel }}">{{ $ator->pivot->papel }}</div>
                        </div>
                    </div>
                </div>
            @empty
