    ...
    <div class="container mt-5 min-vh-100">
        <div class="row justify-content-center">
            <div class="col-md-6 col-sm-12">
                ...
                <form action="/register" method="POST" class="card p-5 needs-validation bg-dark" novalidate  enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" class="form-control" id="foto_perfil" name="foto_perfil" value="{{ old('foto_perfil') }}">
                    </div>
