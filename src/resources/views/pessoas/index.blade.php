...
@section('conteudo')
    <div class="container min-vh-100 mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a class="btn btn-primary btn-lg" href="/pessoas/create">Cadastrar Pessoa</a>
        </div>
            ...
            @forelse ($pessoas as $pessoa)
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="card bg-dark text-light border-secondary h-100 shadow-sm">
                        <a href="/pessoas/{{ $pessoa->id }}" class="text-decoration-none text-light">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="pt-2 border-top border-secondary">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form action="/pessoas/{{ $pessoa->id }}" method="POST" class="d-inline"
